...
import {doesEmailExist, doesUsernameExist} from "../services/firebase";
            ...
            <div className="flex flex-col w-2/5">
                <div className="flex flex-col items-center bg-white p-4 border border-gray-primary mb-4 rounded">
                    ...
                    <form onSubmit={handleSignup} method="POST">
                        <input
                            aria-level="Enter your Username"
                            type="text"
                        ...
                        <input
                            aria-level="Enter your Full Name"
                            type="text"
                        ...
                        <input
                            aria-level="Enter your email address"
                            type="text"
                        ...
                        <input
                            aria-level="Enter your password"
                            type="password"
